...
import { splitLoanRequestsByTabs, mapLoanRequestsToTabDetails, LoanRequestsByTabs, TabDetails } from './loansUtils';
...
const Loans: React.FC = () => {
  ...
  const loanRequestsByTab: LoanRequestsByTabs = React.useMemo(() => (splitLoanRequestsByTabs(loanRequests)), [loanRequests]);
  ...
  return (
    <>
      ...
      <LoansTabs tabs={tabDetailsList} activeTab={tabValue} setTabValue={setTabValue} />
